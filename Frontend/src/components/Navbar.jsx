 ...
 useEffect(() => {
  ...
  return (
    <>
      ...
      scrolled
      ? "bg-base-200 dark:bg-slate-700 dark:text-white shadow-md" 
      : "bg-base-200 dark:bg-slate-900 dark:text-white" // Default state
  } p-4} `}>
        <div className="navbar  shadow-sm">
          ...
          <div className="navbar-end space-x-2">
            ...
            <div className="hidden md:block ">
              <label className="input p-3 border rounded">
                <svg
            ...
            <div>
              <a className="bg-black text-white px-2 py-2 rounded-md hover:bg-slate-600 duration-300 cursor-pointer " onClick={ ()=> document.getElementById("my_modal_3").showModal()}>
                Login
              </a>
              <Login/>
            </div>
